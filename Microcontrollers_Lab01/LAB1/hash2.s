...
hash2:
	...
	loopH:
		...
		sub R5, R0, R3  // R5 = R0 - q*10 = remainder = dividend - quotient*10 
	...
	sum_done:
		cmp R1, #9 //check if sum R1 is single number
		IT gt
		movgt R0, R1 //if total sum > 9, then R0 = R1:number to find the sum of digits again
...
//alternative way of division using subtractions (without sdiv, lines 19-23) 
