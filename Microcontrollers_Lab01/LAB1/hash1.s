...
hash1:
	...
	loop:
		...
		cmp R1, #90 
		bgt loop //if R1 > Z, isnt letter nor digit cause 90>57='9', go to next char
		
		//if letter
		sub R4, R1, #65 //find i of hashtable, i =  R4 = R1 - 65 
		ldrb R5, [R3, R4] //find key in hash_table, R5 = mem{R3 + R4}
